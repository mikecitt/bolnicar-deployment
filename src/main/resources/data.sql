...
INSERT INTO appointment (
    ...
    (PARSEDATETIME('2020-07-02 11:30', 'yyyy-MM-dd HH:mm'), 0.2, 30, 1, 3, 10, NULL, NULL, 5, FALSE),
    (PARSEDATETIME('2020-07-02 17:30', 'yyyy-MM-dd HH:mm'), 0.2, 30, 1, 3, 8, NULL, NULL, 5, FALSE),
    (PARSEDATETIME('2020-07-02 11:30', 'yyyy-MM-dd HH:mm'), 0.2, 30, 1, 3, 7, NULL, 1, 5, TRUE),
    (PARSEDATETIME('2020-07-02 11:30', 'yyyy-MM-dd HH:mm'), 0.2, 30, 1, 3, 11, NULL, 2, 5, TRUE),
    (PARSEDATETIME('2020-07-02 11:30', 'yyyy-MM-dd HH:mm'), 0.2, 30, 1, 3, 11, NULL, 6, 5, TRUE),
    (PARSEDATETIME('2020-07-02 11:30', 'yyyy-MM-dd HH:mm'), 0.2, 30, 1, 3, 11, NULL, 7, 5, TRUE),
    (PARSEDATETIME('2020-07-02 11:30', 'yyyy-MM-dd HH:mm'), 0.2, 30, 1, 3, 11, NULL, 8, 5, TRUE),
    (PARSEDATETIME('2020-07-02 08:00', 'yyyy-MM-dd HH:mm'), 0.2, 30, 1, 9, 11, NULL, 8, 5, TRUE),
